#!/bin/bash
# Ralph Loop for OpenCode (Nope version)
# Usage: nope-ralph.sh [max_iterations]
# Run from your project root directory
# 
# Installation: Copy this file to ~/.local/bin/nope-ralph.sh
